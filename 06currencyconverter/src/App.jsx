        ...
        <div className='w-full' >
          <div className='w-full max-w-md mx-auto border border-grey-60 rounded-lg p-5 backdrop-blur-sm bg-white/30' >
            <form onSubmit={(e)=>{ 
              ...
              <button className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-blue-500 text-white p-2 rounded-lg'
                onClick={swap}
              >Swap</button>
              </div>
              {/*To currency change input field*/}
              <div className='w-full mb-1' >
                 <InputBox 
                  label="to"
                  currencyOptions={options}
